  ...
  return (
    <article className="mb-6 flex flex-wrap">
      <div className="mb-6 ml-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-3/12">
        <div
          className="ripple relative  mb-6 overflow-hidden  rounded-lg bg-cover  bg-no-repeat  shadow-lg"
      ...
      <div className="mb-6 mr-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-9/12 xl:w-7/12">
        ...
        <div className="mb-3 flex items-center justify-center text-sm font-medium text-red-600 md:justify-start">
          <svg
